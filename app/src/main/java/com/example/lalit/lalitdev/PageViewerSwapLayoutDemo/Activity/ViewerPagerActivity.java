...
public class ViewerPagerActivity extends Activity {

   private CashEqulityFragment carouselFragment;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_viewe_page_layout);
    ...
    private void initScreen() {
        ...
        carouselFragment = new CashEqulityFragment();
