...
public class MyData {
    ...
    static Integer[] drawableArray = {R.drawable.camera_icon2, R.drawable.camera_icon2, R.drawable.camera_icon2,
            R.drawable.camera_icon2, R.drawable.camera_icon2, R.drawable.camera_icon2, R.drawable.camera_icon2,
            R.drawable.camera_icon2, R.drawable.camera_icon2, R.drawable.camera_icon2,R.drawable.camera_icon2};
